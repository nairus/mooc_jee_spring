...
public interface UserDao {
     ...
     */
    void add( User user, String password ) throws SQLException;
     ...
     */
    void update( User user, String password ) throws SQLException;
     ...
     */
    long checkPassword( String email, String password ) throws SQLException;
     ...
     */
    long exists( String email ) throws SQLException;
